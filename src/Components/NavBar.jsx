...
export default function NavBar({ onSearchBarValueChange, onCartButtonClick})
{
    return <div className="navbar-container">
        <div className="navbar-logo">
            <svg viewBox="0 0 512 512" fill="currentColor" height="30px" width="30px">
            ...
            <div id="title-electronics">Fuad Electronics</div>
        </div>
        ...
        <div className="navbar-link-container">
            <div className="navbar-link" onClick={onCartButtonClick}>
